...
Here is an [example config](https://gitlab.com/gitlab-com/gl-infra/argocd/apps/-/blob/main/services/prometheus-agent-gitlab/env/ops/clusters/ops-gitlab-gke/values.yaml)
