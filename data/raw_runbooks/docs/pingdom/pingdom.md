...
We have [pingdom exporter](https://github.com/jusbrasil/pingdom-exporter/) deployed in OPS through [ArgoCD](https://gitlab.com/gitlab-com/gl-infra/argocd/apps/-/tree/main/services/pingdom-exporter).
