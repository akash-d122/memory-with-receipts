...
1. [#infrastructure_platforms](https://gitlab.slack.com/messages/infrastructure_platforms) (just barely) contains the SRE's who between them have a fair amount of experience with doing these things for real, and are happy to help
