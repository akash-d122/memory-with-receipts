...
Visit the [Gitaly Version Tracker](https://dashboards.gitlab.net/d/gitaly-version-tracker/gitaly-gitaly-version-tracker?orgId=1&var-environment=gprd)
...
1. `/chatops gitlab run auto_deploy status`
